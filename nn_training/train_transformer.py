...
from models.transformer import FittingTransformer
...
def train_epoch(model, optimizer, disable):
    model.train()
    losses = 0.
    ...
    for i, data in t:
        ...
        # loss calculation
        pred_packed = torch.nn.utils.rnn.pack_padded_sequence(preds, src_len, batch_first=False, enforce_sorted=False)
